/**
 * Masonry Calculator Implementation
 * Extends the base calculator functionality
 */

class MasonryCalculator extends CalculatorBase {
    constructor() {
        super('masonry');
    }
    ...
    calculate() {
        try {
            ...
            if (window.trackCalculatorUsage) {
                window.trackCalculatorUsage('masonry', 'calculate');
            }
        } catch (error) {
...
document.addEventListener('DOMContentLoaded', function() {
    window.calculator = new MasonryCalculator();
});