/**
 * Fencing Calculator Implementation
 * Extends the base calculator functionality
 */

class FencingCalculator extends CalculatorBase {
    constructor() {
        super('fencing');
    }
    ...
    calculate() {
        try {
            ...
            if (window.trackCalculatorUsage) {
                window.trackCalculatorUsage('fencing', 'calculate');
            }
        } catch (error) {
...
document.addEventListener('DOMContentLoaded', function() {
    window.calculator = new FencingCalculator();
});