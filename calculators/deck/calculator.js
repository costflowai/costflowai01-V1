/**
 * Deck Calculator Implementation
 * Extends the base calculator functionality
 */

class DeckCalculator extends CalculatorBase {
    constructor() {
        super('deck');
    }
    ...
    calculate() {
        try {
            ...
            if (window.trackCalculatorUsage) {
                window.trackCalculatorUsage('deck', 'calculate');
            }
        } catch (error) {
...
document.addEventListener('DOMContentLoaded', function() {
    window.calculator = new DeckCalculator();
});