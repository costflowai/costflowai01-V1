/**
 * Stairs Calculator Implementation
 * Extends the base calculator functionality
 */

class StairsCalculator extends CalculatorBase {
    constructor() {
        super('stairs');
    }
    ...
    calculate() {
        try {
            ...
            if (window.trackCalculatorUsage) {
                window.trackCalculatorUsage('stairs', 'calculate');
            }
        } catch (error) {
...
document.addEventListener('DOMContentLoaded', function() {
    window.calculator = new StairsCalculator();
});