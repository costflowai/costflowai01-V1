/**
 * Roofing Calculator Implementation
 * Extends the base calculator functionality
 */

class RoofingCalculator extends CalculatorBase {
    constructor() {
        super('roofing');
    }
    ...
    calculate() {
        try {
            ...
            if (window.trackCalculatorUsage) {
                window.trackCalculatorUsage('roofing', 'calculate');
            }
        } catch (error) {
...
document.addEventListener('DOMContentLoaded', function() {
    window.calculator = new RoofingCalculator();
});