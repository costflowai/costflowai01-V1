/**
 * Excavation Calculator Implementation
 * Extends the base calculator functionality
 */

class ExcavationCalculator extends CalculatorBase {
    constructor() {
        super('excavation');
    }
    ...
    calculate() {
        try {
            ...
            if (window.trackCalculatorUsage) {
                window.trackCalculatorUsage('excavation', 'calculate');
            }
        } catch (error) {
...
document.addEventListener('DOMContentLoaded', function() {
    window.calculator = new ExcavationCalculator();
});