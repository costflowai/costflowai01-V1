/**
 * Steel Calculator Implementation
 * Extends the base calculator functionality
 */

class SteelCalculator extends CalculatorBase {
    constructor() {
        super('steel');
    }
    ...
    calculate() {
        try {
            ...
            if (window.trackCalculatorUsage) {
                window.trackCalculatorUsage('steel', 'calculate');
            }
        } catch (error) {
...
document.addEventListener('DOMContentLoaded', function() {
    window.calculator = new SteelCalculator();
});