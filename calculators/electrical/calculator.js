/**
 * Electrical Calculator Implementation
 * Extends the base calculator functionality
 */

class ElectricalCalculator extends CalculatorBase {
    constructor() {
        super('electrical');
    }
    ...
    calculate() {
        try {
            ...
            if (window.trackCalculatorUsage) {
                window.trackCalculatorUsage('electrical', 'calculate');
            }
        } catch (error) {
...
document.addEventListener('DOMContentLoaded', function() {
    window.calculator = new ElectricalCalculator();
});